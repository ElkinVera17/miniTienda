...
### APIs consumidas
- JSONPlaceholder (https://jsonplaceholder.typicode.com/users) — usuarios simulados
- DummyJSON (https://dummyjson.com/products) — productos simulados
- Dog CEO API (https://dog.ceo/api/breeds/image/random) — imagen de perfil
...
- Ingresar a la carpeta del proyecto: cd miniTienda
